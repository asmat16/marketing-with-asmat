  ...
  return (
    <section className="border-t border-white/[0.08] py-20">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <div className="card-hover relative overflow-hidden rounded-3xl border border-teal-500/20 bg-gradient-to-br from-[var(--card)] via-[var(--surface)] to-indigo-950/40 px-8 py-14 text-center sm:px-16">
          <div
            aria-hidden
